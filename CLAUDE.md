...
- **Say it in fewer words** - if a paragraph can be two sentences without losing meaning, it should be. Extra words don't add clarity, they dilute the point. Write tight. First drafts are almost always too long. This is the single most common problem in Claude's writing. Every draft needs a compression pass. Cut sentences that restate what the previous sentence already said. Cut paragraphs that exist only to transition between ideas when the ideas can just sit next to each other. If you removed a sentence and the paragraph still makes the same point, it should never have been there.
